...
const CancelOrderModal = ({ order, item, isOpen, onClose, onConfirm, title = "Cancel Order" }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-gray-900 border border-gray-800 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full bg-gray-800/50 border border-gray-700 rounded-2xl p-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-red-500/50 min-h-[100px] resize-none transition-all"
                                required
                            />
                        </div>
                        ...
                        <div className="flex gap-3">
                            <button
                                type="button"
                                onClick={onClose}
                                className="flex-1 py-3.5 bg-gray-800 hover:bg-gray-700 text-white font-bold rounded-2xl transition-all active:scale-95"
                            >
                                Nevermind
                            </button>
                            <button
