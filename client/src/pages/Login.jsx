    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[var(--theme-bg-dark)] relative overflow-hidden">
            ...
            <div className="mb-8 z-10 flex flex-col items-center animate-fade-in-down">
                ...
                <h1 className="text-3xl font-bold text-[var(--theme-text-main)] tracking-wide">{settings.restaurantName}</h1>
                <p className="text-sm text-[var(--theme-text-muted)] font-medium tracking-wider uppercase mt-1">Smart POS & Kitchen Management</p>
            </div>

            {/* Login Card */}
            <div className="w-full max-w-md bg-[var(--theme-bg-card)] p-8 rounded-2xl shadow-2xl border border-[var(--theme-border)] z-10 animate-fade-in-up">
                <div className="mb-8">
            ...
            <div className="mt-8 z-10 w-full max-w-md animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="grid grid-cols-4 gap-2 mt-6">
                    <button type="button" onClick={() => { setUsername('admin'); setPassword('admin123'); }} className="flex flex-col items-center justify-center p-3 bg-[var(--theme-bg-card)] hover:bg-[var(--theme-bg-hover)] rounded-xl border border-[var(--theme-border)] transition-all group active:scale-95">
                    ...
                    <button type="button" onClick={() => { setUsername('waiter'); setPassword('waiter123'); }} className="flex flex-col items-center justify-center p-3 bg-[var(--theme-bg-card)] hover:bg-[var(--theme-bg-hover)] rounded-xl border border-[var(--theme-border)] transition-all group active:scale-95">
                    ...
                    <button type="button" onClick={() => { setUsername('kitchen'); setPassword('cook123'); }} className="flex flex-col items-center justify-center p-3 bg-[var(--theme-bg-card)] hover:bg-[var(--theme-bg-hover)] rounded-xl border border-[var(--theme-border)] transition-all group active:scale-95">
                    ...
                    <button type="button" onClick={() => { setUsername('cashier'); setPassword('pay123'); }} className="flex flex-col items-center justify-center p-3 bg-[var(--theme-bg-card)] hover:bg-[var(--theme-bg-hover)] rounded-xl border border-[var(--theme-border)] transition-all group active:scale-95">
