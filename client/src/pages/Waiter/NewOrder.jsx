        ...
        <div className="h-full flex flex-col relative overflow-hidden">
            ...
            {step === 1 && (
                <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-8 animate-fade-in">
                    <h2 className="text-2xl md:text-4xl font-black text-white text-center">Start New Order</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                        <button
                            onClick={() => { setOrderType('dine-in'); setStep(2); }}
                            className="group relative bg-[#1e293b] p-8 md:p-12 rounded-3xl border border-gray-700/50 hover:border-orange-500/50 transition-all shadow-xl flex flex-col items-center text-center space-y-4 active:scale-95"
                        >
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white uppercase tracking-wide">Dine-In</h3>
                                <p className="text-gray-500 text-sm mt-1">Select a table and serve guests</p>
                            </div>
                        ...
                        <button
                            ...
                            className="group relative bg-[#1e293b] p-8 md:p-12 rounded-3xl border border-gray-700/50 hover:border-blue-500/50 transition-all shadow-xl flex flex-col items-center text-center space-y-4 active:scale-95"
                        >
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white uppercase tracking-wide">Takeaway</h3>
                                <p className="text-gray-500 text-sm mt-1">Direct tokens for self-pickup</p>
                            </div>
                ...
                <div className="flex-1 flex flex-col animate-fade-in">
                    <div className="flex items-center justify-between mb-6 px-2">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">Tap an available table to start ordering</p>
                        </div>
                        <button onClick={() => setStep(1)} className="p-3 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-xl transition-all">
                            <ArrowLeft size={20} />
                        </button>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col min-w-0 bg-[#1e293b] rounded-3xl border border-gray-700/50 shadow-2xl overflow-hidden">
                        ...
                        <div className="px-5 py-4 border-b border-gray-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4 flex-shrink-0">
                            <div className="flex items-center gap-3">
                                <button onClick={() => setStep(selectedTable ? 2 : 1)} className="p-2 text-gray-400 hover:text-white bg-gray-800 rounded-lg">
                                    <ArrowLeft size={18} />
                                </button>
                                <div>
                                    <h2 className="text-lg font-bold text-white flex items-center gap-2 truncate">
                                        ...
                                        <span className="text-xs px-2 py-0.5 rounded-full bg-gray-700 text-gray-400 font-normal">Step 3 of 3</span>
                                    </h2>
                                </div>
                            </div>
                                ...
                                {categories.map(cat => (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${selectedCategory === cat._id ? 'bg-orange-500/10 text-orange-400 border-orange-500' : 'text-gray-500 hover:text-gray-300 border-transparent'}
                                        `}
                                    >
                        ...
                        <div className="relative h-full w-full max-w-[400px] ml-auto lg:ml-0 bg-[#1e293b] rounded-none lg:rounded-3xl border-l lg:border border-gray-700 shadow-2xl flex flex-col overflow-hidden">
                            ...
                            <div className="px-5 py-5 border-b border-gray-700 flex items-center justify-between flex-shrink-0">
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mt-0.5">{orderType} • {cart.length} items</p>
                                </div>
