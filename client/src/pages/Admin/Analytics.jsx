...
const Analytics = () => {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center min-h-[400px]">
            ...
            <p className="mt-4 text-gray-500 text-sm font-bold animate-pulse uppercase tracking-widest">Generating Insights...</p>
        </div>
    );
    ...
    return (
        <div className="space-y-6 animate-fade-in" ref={dashboardRef}>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[var(--theme-bg-card)] p-5 rounded-2xl border border-[var(--theme-border)]">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--theme-text-main)]">Enterprise Analytics</h1>
                    <p className="text-sm text-[var(--theme-text-muted)] mt-1">Real-time performance metrics across all branches</p>
                </div>
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                        ...
                        className="p-2.5 bg-[var(--theme-bg-hover)] text-[var(--theme-text-muted)] hover:text-white rounded-xl transition-colors border border-[var(--theme-border)]"
                        disabled={refreshing}
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <SummaryCard
                    title="Growth Rate"
                    value="+12.4%" // Simplified for demo as we have dedicated growth API elsewhere
                    icon={TrendingUp}
                    color="purple"
                />
            </div>
                    ...
                    <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                            <BarChart data={waiters} layout="vertical">
                                ...
                                <Tooltip
                                    contentStyle={{ backgroundColor: 'var(--theme-bg-dark)', borderColor: 'var(--theme-border)', borderRadius: '12px' }}
